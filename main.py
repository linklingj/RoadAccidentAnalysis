...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--road-model", type=str, default="models/road.pt", help="Road YOLO model path")
    parser.add_argument("--crosswalk-model", type=str, default="models/crosswalk.pt", help="Crosswalk YOLO model path")
    parser.add_argument("--object-model", type=str, default="models/object.pt", help="Object YOLO model path")
